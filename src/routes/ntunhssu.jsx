    ...
    const DropdownButton = ({label, isOpen, onClick}) => {
        return (
            <button type="button" onClick={onClick}>
                {label} {isOpen ? <Icon className="inline text-2xl mx-1" icon="line-md:upload-loop" /> : <Icon className="inline text-2xl mx-1" icon="line-md:download-loop" />}
            </button>
        );
    };
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            ...
            <div className="bg-white p-6 rounded shadow-md max-w-7xl mx-auto">
                <h1 className="text-2xl font-bold mb-4">國立臺北護理健康大學 課程查詢系統<Icon className="inline mx-2 text-2xl text-green-900" icon="line-md:clipboard-list-twotone"  /></h1>
   ...
   className="mx-8"
                    ...
                    <div className="flex justify-center w-full">
                        <button
                           ...
                           系所/年級/課別 {isOpen.departmentGradeType ? <Icon className="inline text-2xl mx-1" icon="line-md:upload-loop" /> : <Icon className="inline text-2xl mx-1" icon="line-md:download-loop" />}
                        </button>
                        <button
                            ...
                            星期 {isOpen.weekday ?  <Icon className="inline text-2xl mx-1" icon="line-md:upload-loop" /> : <Icon className="inline text-2xl mx-1" icon="line-md:download-loop" />}
                        </button>
                        <button
                            ...
                            學制 {isOpen.system ? <Icon className="inline text-2xl mx-1" icon="line-md:upload-loop" /> : <Icon className="inline text-2xl mx-1" icon="line-md:download-loop" />}
                        </button>
                        <button
                            ...
                            節次 {isOpen.period ? <Icon className="inline text-2xl mx-1" icon="line-md:upload-loop" /> : <Icon className="inline text-2xl mx-1" icon="line-md:download-loop" />}
                        </button>
                        ...
                        <button
                            ...
                            課程內容分類 {isOpen.courseCategory ? <Icon className="inline text-2xl mx-1" icon="line-md:upload-loop" /> : <Icon className="inline text-2xl mx-1" icon="line-md:download-loop" />}
                        </button>
                        ...
                        <button
                            ...
                            教師/課程 {isOpen.teacherCourse ? <Icon className="inline text-2xl mx-1" icon="line-md:upload-loop" /> : <Icon className="inline text-2xl mx-1" icon="line-md:download-loop" />}
                        </button>
                    </div>
                    <div>
                    ...
                    <div className="mt-4">
                        <button type="submit"
                                className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600"><Icon className="inline text-2xl mx-1"  icon="line-md:search-filled" />查詢
                        </button>
                    </div>
                </form>
            </div>
